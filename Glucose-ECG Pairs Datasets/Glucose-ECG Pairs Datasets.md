### Glucose-ECG Pairs Datasets

Datasets with paired ECG and glucose/CGM data, ideal for your multimodal framework.

- **D1NAMO**
  - **Link**: https://zenodo.org/records/1421616 (or Kaggle: https://www.kaggle.com/datasets/sarabhian/d1namo-ecg-glucose-data)
  - **Description**: 29 subjects (20 healthy, 9 T1D); ECG, breathing, accelerometer, CGM, annotated meals; ~4 days/subject; public.
...
- **CGMacros**
  ...
  - **Referred Papers**: Personalized nutrition.
  - **Original Dataset Paper**: "CGMacros: a scientific dataset for personalized nutrition and diet monitoring" (under review, 2025) (described on PhysioNet).

- **HUPA-UCM Diabetes Dataset**
  - **Link**: https://data.mendeley.com/datasets/3hbcscwz44/1
  - **Description**: 25 T1D subjects; CGM, insulin, carbs, heart rate, steps, calories, sleep (ECG-derived? HR from wearables); public.
  - **Referred Papers**: Glucose prediction, sleep analysis.
